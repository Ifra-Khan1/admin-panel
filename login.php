...
if(isset($_POST['Login'])){
   ...
   $verify = " SELECT * From `admin_info` where email = '$log_email'";
   $connect_login = mysqli_query($connection , $log_email);
   ...
   if(mysqli_num_rows($connect_login) >0){
      ...
      if ($pass_decode){
         ...
         header('location:http://localhost:82/new%20php/index.php');
      }
      else{
